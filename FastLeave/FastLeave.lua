...
elseif locale == "ruRU" then
    ...
    L.CANT_COMBAT = "Невозможно выйти из группы, пока Вы в бою."
    L.RESET_DONE = "Положение и размер сброшены."
    L.LOCKED = "FastLeave заблокирован."
    L.UNLOCKED = "FastLeave разблокирован."
    L.SOLO_TOGGLE = "Показывать, когда Вы один = "
    L.OPTIONS_TITLE = "Настройки FastLeave"
    L.OPTIONS_LOCK = "Заблокировать рамку"
    L.OPTIONS_UNLOCK = "Разблокировать рамку"
    L.OPTIONS_SHOW_SOLO = "Показывать, когда Вы один"
